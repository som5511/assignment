    ...
    <div className="flex h-screen">
        ...
        <div className="p-4 flex-grow overflow-y-auto">
          ...
          <ul>
            <li className="mb-2 cursor-pointer">
              <div className="font-semibold"><a href = "http://localhost:5173/course1">1. Introduction to Machine Learning</a></div>
      ...
      <div className="w-3/4 bg-gray-100 p-8 overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <CourseHeading label = {"Introduction to Machine Learning"}></CourseHeading>
        </div>
        <div className="mb-4">
        ...
        <div className="bg-white p-4 rounded-lg shadow mb-4">
          <button>
            <a href = "http://localhost:5173/course2">
              Next
            </a>
          </button>
        </div>
